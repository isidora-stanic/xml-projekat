...
public class SpisakKorisnika {
    ...
    protected List<SpisakKorisnika.Korisnik> korisnik;
     ...
     * {@link SpisakKorisnika.Korisnik }
     * 
     * 
     */
    public List<SpisakKorisnika.Korisnik> getKorisnik() {
        if (korisnik == null) {
            korisnik = new ArrayList<SpisakKorisnika.Korisnik>();
        }
    ...
    public static class Korisnik {
        ...
        @XmlElement(namespace = "www.rokzasok.rs/korisnici", required = true)
        protected SpisakKorisnika.Korisnik.Uloge uloge;
         ...
         * @return
         *     possible object is
         *     {@link SpisakKorisnika.Korisnik.Uloge }
         *     
         */
        public SpisakKorisnika.Korisnik.Uloge getUloge() {
            return uloge;
        }
         ...
         *     
         */
        public void setUloge(SpisakKorisnika.Korisnik.Uloge value) {
            this.uloge = value;
        }
