 ...
 * generated in the com.rokzasok.portal.za.imunizaciju.dokumenti.gradjanin.iskazivanje_interesovanja package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rokzasok.portal.za.imunizaciju.dokumenti.gradjanin.iskazivanje_interesovanja
     * 
     */
    ...
    public JAXBElement<String> createJMBG(String value) {
        return new JAXBElement<>(_JMBG_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<TPol> createPol(TPol value) {
        return new JAXBElement<>(_Pol_QNAME, TPol.class, null, value);
    }
    ...
    public JAXBElement<String> createBrojPasosa(String value) {
        return new JAXBElement<>(_BrojPasosa_QNAME, String.class, null, value);
    }
