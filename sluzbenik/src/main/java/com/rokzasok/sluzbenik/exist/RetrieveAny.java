...
public class RetrieveAny {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RetrieveAny.run(www.rokzasok.rs.euprava.exist.AuthenticationUtilities.loadProperties(), args);
    }
    ...
    public static void run(ConnectionProperties conn, String args[]) throws Exception {
        ...
        System.out.println("[INFO] " + www.rokzasok.rs.euprava.exist.RetrieveDigitalCertificate.class.getSimpleName());
